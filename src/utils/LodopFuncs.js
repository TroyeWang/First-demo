...
//====获取LODOP对象的主过程：====
export function getLodop(oOBJECT,oEMBED,bAlert){
    ...
    var strDownUrl="<br>打印失败，请下载并安装Lodop打印控件！<a style='color:rgb(255,102,0);' href='http://down.bailingniao.cn/devices/Lodop.rar' target='_self'>点击下载控件</a>";
    var LODOP;
    try{
        ...
        LODOP.SET_LICENSES("","83C86209BA0DA2AFFCC033845EF3F438","C94CEE276DB2187AE6B65D56B3FC2848","");
        //===========================================================
        return LODOP;
